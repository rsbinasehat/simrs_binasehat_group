...
public final class DlgCariPerusahaan extends javax.swing.JDialog {
    ...
    */
    ...
    private void tampil2() {
        Valid.tabelKosong(tabMode);
        try {
            ps=koneksi.prepareStatement("select kode_perusahaan,nama_perusahaan,alamat,kota,no_telp from perusahaan_pasien where nama_perusahaan like '%"+ TCari.getText() +"%' and alamat like '%"+ TCari.getText() +"%' and kota like '%"+ TCari.getText() +"%' order by nama_perusahaan");
            try{           
                rs=ps.executeQuery();
                while(rs.next()){
                    tabMode.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5)});

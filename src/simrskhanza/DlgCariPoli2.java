    ...
    private void tampil2() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "from poliklinik inner join jadwal inner join dokter on poliklinik.kd_poli=jadwal.kd_poli "+
                    "and dokter.kd_dokter=jadwal.kd_dokter "+
                    "where (poliklinik.kd_poli like '%"+ TCari.getText() +"%' or " +
                    "poliklinik.nm_poli like '%"+ TCari.getText() +"%') and " +
                    "poliklinik.status='1' and jadwal.hari_kerja=? group by poliklinik.kd_poli order by poliklinik.nm_poli "); 
            try{                
                switch (day) {
                    case 1:
                        hari="AKHAD";

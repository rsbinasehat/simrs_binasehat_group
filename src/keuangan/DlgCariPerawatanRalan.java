    ...
    private void tampil2() {
        try{     
            ...
            try{     
                ...
                String cari_value=" ((jns_perawatan.kd_jenis_prw LIKE '%"+ TCariTindakan.getText() +
                    "%' OR jns_perawatan.nm_perawatan LIKE '%"+ TCariTindakan.getText() +
                    "%') OR jns_perawatan.nm_kategori LIKE '%"+ TCariTindakan.getText() +"%') AND ";
                
                pstindakan=koneksi.prepareStatement(sql+
                    "where "+ cari_value +" jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') order by jns_perawatan.nm_perawatan "); 
                pstindakan2=koneksi.prepareStatement(sql+
                    "where "+ cari_value +" jns_perawatan.status='1' and (jns_perawatan.kd_pj=? or jns_perawatan.kd_pj='-') order by jns_perawatan.nm_perawatan ");        
                pstindakan3=koneksi.prepareStatement(sql+
                    "where "+ cari_value +" jns_perawatan.status='1' and (jns_perawatan.kd_poli=? or jns_perawatan.kd_poli='-') order by jns_perawatan.nm_perawatan ");     
                pstindakan4=koneksi.prepareStatement(sql+
                    "where "+ cari_value +" jns_perawatan.status='1' order by jns_perawatan.nm_perawatan ");

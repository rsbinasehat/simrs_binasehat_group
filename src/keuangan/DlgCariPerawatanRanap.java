...
//                Valid.tabelKosong(tabMode);
                ...
                String cari_value=" ((jns_perawatan_inap.kd_jenis_prw LIKE '%"+ TCari.getText() +
                    "%' OR jns_perawatan_inap.nm_perawatan LIKE '%"+ TCari.getText() +
                    "%') OR kategori_perawatan.nm_kategori LIKE '%"+ TCari.getText() +"%') AND ";

                pscari = koneksi.prepareStatement(sql
                        + "where "+ cari_value +" jns_perawatan_inap.status='1' and (jns_perawatan_inap.kd_pj=? or jns_perawatan_inap.kd_pj='-') and (jns_perawatan_inap.kd_bangsal=? or jns_perawatan_inap.kd_bangsal='-') order by jns_perawatan_inap.nm_perawatan");
                pscari2 = koneksi.prepareStatement(sql
                        + "where "+ cari_value +" jns_perawatan_inap.status='1' and (jns_perawatan_inap.kd_pj=? or jns_perawatan_inap.kd_pj='-') order by jns_perawatan_inap.nm_perawatan");
                pscari3 = koneksi.prepareStatement(sql
                        + "where "+ cari_value +" jns_perawatan_inap.status='1' and (jns_perawatan_inap.kd_bangsal=? or jns_perawatan_inap.kd_bangsal='-') order by jns_perawatan_inap.nm_perawatan");
                pscari4 = koneksi.prepareStatement(sql
                        + "where "+ cari_value +" jns_perawatan_inap.status='1' order by jns_perawatan_inap.nm_perawatan");
                pscari5 = koneksi.prepareStatement(sql
                        + "where "+ cari_value +" jns_perawatan_inap.status='1' and (jns_perawatan_inap.kd_pj=? or jns_perawatan_inap.kd_pj='-') and (jns_perawatan_inap.kd_bangsal=? or jns_perawatan_inap.kd_bangsal='-') and (jns_perawatan_inap.kelas=? or jns_perawatan_inap.kelas='-') order by jns_perawatan_inap.nm_perawatan");
                pscari6 = koneksi.prepareStatement(sql
                        + "where "+ cari_value +" jns_perawatan_inap.status='1' and (jns_perawatan_inap.kd_pj=? or jns_perawatan_inap.kd_pj='-') and (jns_perawatan_inap.kelas=? or jns_perawatan_inap.kelas='-') order by jns_perawatan_inap.nm_perawatan");
                pscari7 = koneksi.prepareStatement(sql
                        + "where "+ cari_value +" jns_perawatan_inap.status='1' and (jns_perawatan_inap.kd_bangsal=? or jns_perawatan_inap.kd_bangsal='-') and (jns_perawatan_inap.kelas=? or jns_perawatan_inap.kelas='-') order by jns_perawatan_inap.nm_perawatan");
                pscari8 = koneksi.prepareStatement(sql
                        + "where "+ cari_value +" jns_perawatan_inap.status='1' and (jns_perawatan_inap.kelas=? or jns_perawatan_inap.kelas='-') order by jns_perawatan_inap.nm_perawatan");
                try {
                    if (ruang_ranap.equals("Yes") && cara_bayar_ranap.equals("Yes") && kelas_ranap.equals("No")) {
                        pscari.setString(1, kd_pj.trim());
                        pscari.setString(2, kd_bangsal.trim());

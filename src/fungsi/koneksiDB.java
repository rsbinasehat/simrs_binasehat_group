...
public class koneksiDB {
    ...
    public static String TampilkanTarif(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("TAMPILKANTARIF");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String URL_AdamLabs(){
        try{
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var=prop.getProperty("URLADAMLABS");
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String APIKEY_AdamLabs(){
        try (FileInputStream fis = new FileInputStream("setting/database.xml")) {
            prop.loadFromXML(fis);
            var=EnkripsiAES.decrypt(prop.getProperty("APIKEYADAMLABS"));
        }catch(Exception e){
            var=""; 
        }
        return var;
    ...
    public static String KODERS_AdamLabs(){
        try (FileInputStream fis = new FileInputStream("setting/database.xml")) {
            prop.loadFromXML(fis);
            var=EnkripsiAES.decrypt(prop.getProperty("KODERSADAMLABS"));
        }catch(Exception e){
            var=""; 
        }
        return var;

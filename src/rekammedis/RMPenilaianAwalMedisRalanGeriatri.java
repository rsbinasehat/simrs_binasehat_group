...
public final class RMPenilaianAwalMedisRalanGeriatri extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanGeriatri(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Status Kognitif (MMSE)","Status Nutrisi (MNA)","Skrinning Risiko Jatuh (OMS)","Status Fungsional (ADL: BARTHEL INDEX)","Skala Lawton (IADL)","Laboratorium","Radiologi","Penunjang Lainnya","Diagnosis",
    ...
    private void initComponents() {
        ...
        SkalaLawton = new widget.ComboBox();
        ...
        jLabel62.setText("Skala Lawton (IADL) :");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(0, 610, 128, 23);

        SkalaLawton.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0 dikerjakan oleh orang lain", "1 perlu bantuan setiap saat", "2-3 perlu bantuan sesekali","4-8 Independen/mandiri" }));
        SkalaLawton.setName("SkalaLawton"); // NOI18N
        SkalaLawton.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                SkalaLawtonKeyPressed(evt);
            }
        });
        FormInput.add(SkalaLawton);
        SkalaLawton.setBounds(132, 610, 220, 23);
        ...
        scrollPane12.setBounds(594, 680, 260, 63);
        ...
        scrollPane10.setBounds(319, 680, 260, 63);
        ...
        scrollPane9.setBounds(44, 680, 260, 63);
        ...
        scrollPane16.setBounds(454, 790, 400, 43);
        ...
        scrollPane15.setBounds(44, 790, 400, 43);
        ...
        scrollPane20.setBounds(44, 880, 400, 43);
        ...
        scrollPane17.setBounds(454, 880, 400, 43);

        jLabel112.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel112.setText("Tindakan/Rencana Tindakan :");
        jLabel112.setName("jLabel112"); // NOI18N
        FormInput.add(jLabel112);
        jLabel112.setBounds(44, 930, 320, 20);
        ...
        scrollPane19.setBounds(44, 950, 810, 43);
        ...
        jSeparator18.setBounds(0, 1000, 880, 1);

        jLabel110.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel110.setText("VII. EDUKASI");
        jLabel110.setName("jLabel110"); // NOI18N
        FormInput.add(jLabel110);
        jLabel110.setBounds(10, 1000, 190, 23);
        ...
        scrollPane14.setBounds(44, 1020, 810, 63);
            ...
            try{
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Skala Lawton (IADL)</b></td>"+
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanGeriatri.jasper","report","::[ Laporan Pengkajian Awal Medis Rawat Jalan Geriatri ]::",
                ...
                "penilaian_medis_ralan_geriatri.skrining_jatuh,penilaian_medis_ralan_geriatri.status_nutrisi,penilaian_medis_ralan_geriatri.lainnya,penilaian_medis_ralan_geriatri.skala_lawton,penilaian_medis_ralan_geriatri.lab,penilaian_medis_ralan_geriatri.rad,"+
    ...
    private void SkalaLawtonKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SkalaLawtonKeyPressed
        //Valid.pindah(evt,Kognitif,RisikoJatuh);
    }//GEN-LAST:event_SkalaLawtonKeyPressed
    ...
    */
    ...
    private widget.ComboBox SkalaLawton;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "penilaian_medis_ralan_geriatri.keterangan_abdomen,penilaian_medis_ralan_geriatri.ekstremitas,penilaian_medis_ralan_geriatri.keterangan_ekstremitas,penilaian_medis_ralan_geriatri.Integument_kebersihan,"+
                        "penilaian_medis_ralan_geriatri.Integument_warna,penilaian_medis_ralan_geriatri.Integument_kelembaban,penilaian_medis_ralan_geriatri.Integument_gangguan_kulit,penilaian_medis_ralan_geriatri.status_fungsional,"+
                        "penilaian_medis_ralan_geriatri.skrining_jatuh,penilaian_medis_ralan_geriatri.status_nutrisi,penilaian_medis_ralan_geriatri.skala_lawton,penilaian_medis_ralan_geriatri.lainnya,penilaian_medis_ralan_geriatri.lab,penilaian_medis_ralan_geriatri.rad,"+
                        "penilaian_medis_ralan_geriatri.pemeriksaan,penilaian_medis_ralan_geriatri.diagnosis,penilaian_medis_ralan_geriatri.diagnosis2,penilaian_medis_ralan_geriatri.permasalahan,penilaian_medis_ralan_geriatri.terapi,"+
                        "penilaian_medis_ralan_geriatri.tindakan,penilaian_medis_ralan_geriatri.edukasi "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ralan_geriatri on reg_periksa.no_rawat=penilaian_medis_ralan_geriatri.no_rawat "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("status_kognitif_mmse"),rs.getString("status_nutrisi"),rs.getString("skrining_jatuh"),rs.getString("status_fungsional"),rs.getString("skala_lawton"),rs.getString("lab"),rs.getString("rad"),rs.getString("pemeriksaan"),
    ...
    public void emptTeks() {
        ...
        SkalaLawton.setSelectedIndex(0);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            SkalaLawton.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString());
            ...
            Lab.setText(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
            Rad.setText(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString());
            PenunjangLain.setText(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString());
            Diagnosis2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),45).toString());
            Permasalahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),46).toString());
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),47).toString());
            Tindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),48).toString());
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan_geriatri","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,tulang_belakang=?,td=?,nadi=?,suhu=?,rr=?,kondisi_umum=?,"+
                ...
                "tindakan=?,edukasi=?,skala_lawton=?",46,new String[]{
                ...
                Permasalahan.getText(),Terapi.getText(),Tindakan.getText(),Edukasi.getText(),SkalaLawton.getSelectedItem().toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
               ...
               tbObat.setValueAt(SkalaLawton.getSelectedItem().toString(),tbObat.getSelectedRow(),40);
               tbObat.setValueAt(Lab.getText(),tbObat.getSelectedRow(),41);
               tbObat.setValueAt(Rad.getText(),tbObat.getSelectedRow(),42);
               tbObat.setValueAt(PenunjangLain.getText(),tbObat.getSelectedRow(),43);
               tbObat.setValueAt(Diagnosis.getText(),tbObat.getSelectedRow(),44);
               tbObat.setValueAt(Diagnosis2.getText(),tbObat.getSelectedRow(),45);
               tbObat.setValueAt(Permasalahan.getText(),tbObat.getSelectedRow(),46);
               tbObat.setValueAt(Terapi.getText(),tbObat.getSelectedRow(),47);
               tbObat.setValueAt(Tindakan.getText(),tbObat.getSelectedRow(),48);
               tbObat.setValueAt(Edukasi.getText(),tbObat.getSelectedRow(),49);
               TabRawat.setSelectedIndex(1);
        }
    }

    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ralan_geriatri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",45,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),PosturTulang.getSelectedItem().toString(),TD.getText(),Nadi.getText(),Suhu.getText(),RR.getText(),KondisiUmum.getText(),
                Psikologis.getSelectedItem().toString(),KondisiSosial.getText(),Kognitif.getSelectedItem().toString(),Kepala.getSelectedItem().toString(),KeteranganKepala.getText(),Thoraks.getSelectedItem().toString(),
                KeteranganThoraks.getText(),Abdomen.getSelectedItem().toString(),KeteranganAbdomen.getText(),Ekstremitas.getSelectedItem().toString(),KeteranganEkstremitas.getText(),IntegumentKebersihan.getSelectedItem().toString(),
                IntegumentWarna.getSelectedItem().toString(),IntegumentKelembaban.getSelectedItem().toString(),IntegumentGangguan.getSelectedItem().toString(),Fungsional.getSelectedItem().toString(),
                RisikoJatuh.getSelectedItem().toString(),Nutrisi.getSelectedItem().toString(),SkalaLawton.getSelectedItem().toString(),Lainnya.getText(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),Diagnosis2.getText(),
                ...
                tabMode.addRow(new Object[]{
                    ...
                    Fungsional.getSelectedItem().toString(),SkalaLawton.getSelectedItem().toString(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),Diagnosis2.getText(),Permasalahan.getText(),Terapi.getText(),Tindakan.getText(),Edukasi.getText()
                });
                LCount.setText(""+tabMode.getRowCount());
                emptTeks();
        }

...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private ApiAdamLabs AdamLabs=new ApiAdamLabs();
    ...
    private void initComponents() {
        ...
        BtnKirimAdamLabs.setText("Kirim Permintaan ke Adam Labs");
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    AdamLabs.kirimRalan(NoPermintaan);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
            }else{            
            ...
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    AdamLabs.kirimRanap(NoPermintaan);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
            }else{            
